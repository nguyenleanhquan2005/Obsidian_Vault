...
| **Ứng dụng chính**                  | **Lớp đầu ra** của bài toán phân loại nhiều lớp (multiclass, classification)<br><br>attention mechanism                                       | **Lớp ẩn** của mạng nơ-ron sâu (CNN, MLP, ResNet, Transformer...)                                   | **Lớp đầu ra** cho phân loại nhị phân; ít dùng trong lớp ẩn hiện nay<br>multi-label **Classification**<br><br>LSTM, GRU | **Lớp ẩn** trong các mạng cũ (RNN cổ điển); hoặc lớp đầu ra cho bài toán regression với giá trị trong (-1,1)(Gioi han)        |
